# reference: https://github.com/LyQuid12/Discord-RPC/blob/main/DiscordRPC/presence.py
...
class RPC(metaclass=ABCMeta):
    ...
    def _do_handshake(self):
        ...
        self.user = ret_data['data']['user']
        print("Connected to " + self.user['username'] + " (" + self.user['id'] + ")")
...
class DiscordWindows(RPC):
    ...
    def _connect(self):
        for i in range(10):
            ...
            raise Exception("discord not open")
